...
public class ProductInShopProvider {
    ...
    private static void init() {
        if(productsInShops == null) {
            ...
            productsInShops.add(new ProductInShop(101, ProductProvider.getProductById(1), ShopProvider.getShopByName("Rewe"), 0.99));
            productsInShops.add(new ProductInShop(102, ProductProvider.getProductById(2), ShopProvider.getShopByName("Rewe"), 0.99));
            productsInShops.add(new ProductInShop(103, ProductProvider.getProductById(3), ShopProvider.getShopByName("Rewe"), 0.99));
            productsInShops.add(new ProductInShop(104, ProductProvider.getProductById(4), ShopProvider.getShopByName("Rewe"), 0.99));
            ...
            productsInShops.add(new ProductInShop(110, ProductProvider.getProductById(10), ShopProvider.getShopByName("Rewe"), 1.79));
            ...
            productsInShops.add(new ProductInShop(117, ProductProvider.getProductById(17), ShopProvider.getShopByName("Rewe"), 1.19));
            productsInShops.add(new ProductInShop(118, ProductProvider.getProductById(18), ShopProvider.getShopByName("Rewe"), 1.19));
            productsInShops.add(new ProductInShop(119, ProductProvider.getProductById(19), ShopProvider.getShopByName("Rewe"), 1.19));
            productsInShops.add(new ProductInShop(120, ProductProvider.getProductById(20), ShopProvider.getShopByName("Rewe"), 1.39));
            productsInShops.add(new ProductInShop(121, ProductProvider.getProductById(21), ShopProvider.getShopByName("Rewe"), 0.84));
            productsInShops.add(new ProductInShop(122, ProductProvider.getProductById(22), ShopProvider.getShopByName("Rewe"), 0.84));
            productsInShops.add(new ProductInShop(123, ProductProvider.getProductById(23), ShopProvider.getShopByName("Rewe"), 0.69));
            productsInShops.add(new ProductInShop(124, ProductProvider.getProductById(24), ShopProvider.getShopByName("Rewe"), 0.89));
            productsInShops.add(new ProductInShop(125, ProductProvider.getProductById(25), ShopProvider.getShopByName("Rewe"), 2.89));
            productsInShops.add(new ProductInShop(126, ProductProvider.getProductById(26), ShopProvider.getShopByName("Rewe"), 3.59));
            productsInShops.add(new ProductInShop(127, ProductProvider.getProductById(27), ShopProvider.getShopByName("Rewe"), 1.99));
            productsInShops.add(new ProductInShop(128, ProductProvider.getProductById(28), ShopProvider.getShopByName("Rewe"), 1.99));
            productsInShops.add(new ProductInShop(129, ProductProvider.getProductById(29), ShopProvider.getShopByName("Rewe"), 1.29));
            productsInShops.add(new ProductInShop(130, ProductProvider.getProductById(30), ShopProvider.getShopByName("Rewe"), 1.49));
            productsInShops.add(new ProductInShop(131, ProductProvider.getProductById(31), ShopProvider.getShopByName("Rewe"), 1.59));
            productsInShops.add(new ProductInShop(132, ProductProvider.getProductById(32), ShopProvider.getShopByName("Rewe"), 1.59));
            productsInShops.add(new ProductInShop(133, ProductProvider.getProductById(33), ShopProvider.getShopByName("Rewe"), 1.29));
            productsInShops.add(new ProductInShop(134, ProductProvider.getProductById(34), ShopProvider.getShopByName("Rewe"), 0.79));
            productsInShops.add(new ProductInShop(135, ProductProvider.getProductById(35), ShopProvider.getShopByName("Rewe"), 2.69));
            productsInShops.add(new ProductInShop(136, ProductProvider.getProductById(36), ShopProvider.getShopByName("Rewe"), 1.69));
            productsInShops.add(new ProductInShop(137, ProductProvider.getProductById(37), ShopProvider.getShopByName("Rewe"), 1.39));
            productsInShops.add(new ProductInShop(138, ProductProvider.getProductById(38), ShopProvider.getShopByName("Rewe"), 0.99));
            productsInShops.add(new ProductInShop(139, ProductProvider.getProductById(39), ShopProvider.getShopByName("Rewe"), 1.89));
            productsInShops.add(new ProductInShop(140, ProductProvider.getProductById(40), ShopProvider.getShopByName("Rewe"), 2.29));
            productsInShops.add(new ProductInShop(141, ProductProvider.getProductById(41), ShopProvider.getShopByName("Rewe"), 2.09));
            productsInShops.add(new ProductInShop(142, ProductProvider.getProductById(42), ShopProvider.getShopByName("Rewe"), 1.99));
            productsInShops.add(new ProductInShop(143, ProductProvider.getProductById(43), ShopProvider.getShopByName("Rewe"), 1.59));
            productsInShops.add(new ProductInShop(144, ProductProvider.getProductById(44), ShopProvider.getShopByName("Rewe"), 1.19));
            productsInShops.add(new ProductInShop(145, ProductProvider.getProductById(45), ShopProvider.getShopByName("Rewe"), 1.49));
            productsInShops.add(new ProductInShop(146, ProductProvider.getProductById(46), ShopProvider.getShopByName("Rewe"), 1.29));
            productsInShops.add(new ProductInShop(147, ProductProvider.getProductById(47), ShopProvider.getShopByName("Rewe"), 0.89));
            productsInShops.add(new ProductInShop(148, ProductProvider.getProductById(48), ShopProvider.getShopByName("Rewe"), 0.89));
            productsInShops.add(new ProductInShop(149, ProductProvider.getProductById(49), ShopProvider.getShopByName("Rewe"), 0.59));
            productsInShops.add(new ProductInShop(150, ProductProvider.getProductById(50), ShopProvider.getShopByName("Rewe"), 2.89));
