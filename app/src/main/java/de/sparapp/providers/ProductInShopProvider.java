...
public class ProductInShopProvider {
    ...
    private static void init() {
        if(productsInShops == null) {
            ...
            productsInShops.add(new ProductInShop(117, ProductProvider.getProductById(17), ShopProvider.getShopByName("Rewe"), 0.89));
            productsInShops.add(new ProductInShop(118, ProductProvider.getProductById(18), ShopProvider.getShopByName("Rewe"), 0.99));
            productsInShops.add(new ProductInShop(119, ProductProvider.getProductById(19), ShopProvider.getShopByName("Rewe"), 1.09));
            productsInShops.add(new ProductInShop(120, ProductProvider.getProductById(20), ShopProvider.getShopByName("Rewe"), 1.29));
            ...
            productsInShops.add(new ProductInShop(124, ProductProvider.getProductById(24), ShopProvider.getShopByName("Rewe"), 0.79));
            ...
            productsInShops.add(new ProductInShop(129, ProductProvider.getProductById(29), ShopProvider.getShopByName("Rewe"), 1.09));
            ...
            productsInShops.add(new ProductInShop(134, ProductProvider.getProductById(34), ShopProvider.getShopByName("Rewe"), 0.69));
            productsInShops.add(new ProductInShop(135, ProductProvider.getProductById(35), ShopProvider.getShopByName("Rewe"), 2.49));
            productsInShops.add(new ProductInShop(136, ProductProvider.getProductById(36), ShopProvider.getShopByName("Rewe"), 1.59));
            productsInShops.add(new ProductInShop(137, ProductProvider.getProductById(37), ShopProvider.getShopByName("Rewe"), 1.19));
            productsInShops.add(new ProductInShop(138, ProductProvider.getProductById(38), ShopProvider.getShopByName("Rewe"), 0.89));
            ...
            productsInShops.add(new ProductInShop(141, ProductProvider.getProductById(41), ShopProvider.getShopByName("Rewe"), 1.99));
            productsInShops.add(new ProductInShop(142, ProductProvider.getProductById(42), ShopProvider.getShopByName("Rewe"), 1.99));
            productsInShops.add(new ProductInShop(143, ProductProvider.getProductById(43), ShopProvider.getShopByName("Rewe"), 1.29));
            ...
            productsInShops.add(new ProductInShop(146, ProductProvider.getProductById(46), ShopProvider.getShopByName("Rewe"), 0.99));
            ...
            productsInShops.add(new ProductInShop(150, ProductProvider.getProductById(50), ShopProvider.getShopByName("Rewe"), 1.89));
